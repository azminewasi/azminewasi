...
- Actively involved in several ***Machine Learning Research*** projects in **Graph Neural Networks, Computer Vision, Robust Modeling, Explainable AI and Optimization**.
