...
- Actively involved in several [***Machine Learning Research***](https://azminewasi.github.io/research/index.html) projects in **Graph Neural Networks, Computer Vision, Robust Modeling, Explainable AI and Optimization** with [Data Intelligence Lab, HYU, KR](https://dilab.hanyang.ac.kr/), [Computational Intelligence and Operations Lab - CIOL, SUST, BD](https://www.linkedin.com/company/ciol-ipe-sust/) and individual collaboration.
